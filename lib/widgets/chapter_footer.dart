            ...
            : Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: t.textAccent.withValues(alpha: 0.15)),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Text(
                          'This reflection was generated by AI to help you engage with what you\'ve just read. '
                          'It is not divinely inspired, does not carry biblical authority, and is not a substitute '
                          'for the Holy Spirit\'s work in your heart. God alone gives revelation through His Word '
                          '— let Scripture be your guide.',
                          style: t.bodyFont(12).copyWith(
                            color: t.textAccent.withValues(alpha: 0.55),
                            height: 1.65,
